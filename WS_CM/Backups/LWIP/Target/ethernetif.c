...
void HAL_ETH_MspInit(ETH_HandleTypeDef* ethHandle)
{
  ...
  /* USER CODE END ETH_MspInit 0 */
    ...
    */
    ...
    GPIO_InitStruct.Pin = MCU_RMII_TXD0_Pin|MCU_RMII_TXD1_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF11_ETH;
...
void HAL_ETH_MspDeInit(ETH_HandleTypeDef* ethHandle)
{
  ...
  /* USER CODE END ETH_MspDeInit 0 */
    ...
    PG14     ------> ETH_TXD1
    */
    HAL_GPIO_DeInit(GPIOC, MCU_PHY_MDC_Pin|MCU_RMII_RXD0_Pin|MCU_RMII_RXD1_Pin);

    HAL_GPIO_DeInit(GPIOA, MCU_RMII_REF_CLK_Pin|MCU_PHY_MDIO_Pin|MCU_RMII_CRS_DV_Pin);

    HAL_GPIO_DeInit(MCU_RMII_TX_EN_GPIO_Port, MCU_RMII_TX_EN_Pin);

    HAL_GPIO_DeInit(GPIOG, MCU_RMII_TXD0_Pin|MCU_RMII_TXD1_Pin);
