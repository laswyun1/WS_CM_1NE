...
//	Push_Routine(&extDevCtrl.routine, 9);
	...
	//LEFT HIP WIDTH
	IOIF_InitUpright(&pelvicUpright[0], 0,2,2,IOIF_GPIO_PIN_3, IOIF_GPIO_PIN_2, IOIF_GPIO_PIN_0, IOIF_GPIO_PIN_1); 	// HIP_L_L_SW_N_Pin HIP_L_L_SW_P_Pin HIP_L_L_MT_IN1_Pin HIP_L_L_MT_IN2_Pin
	//LEFT HIP DEPTH
	IOIF_InitUpright(&pelvicUpright[1], 1,2,2,IOIF_GPIO_PIN_0, IOIF_GPIO_PIN_1, IOIF_GPIO_PIN_2, IOIF_GPIO_PIN_3);	// HIP_L_D_SW_P_Pin HIP_L_D_SW_N_Pin HIP_L_D_MT_IN1_Pin HIP_L_D_MT_IN2_Pin
	//RIGHT HIP WIDTH
	...
	IOIF_InitLS(&lsObj[0], PELV_UPRIGHT_SLOPE, PELV_UPRIGHT_OFFSET_LEN); //L_L
	IOIF_InitLS(&lsObj[1], PELV_UPRIGHT_SLOPE, PELV_UPRIGHT_OFFSET_DEP); //L_D
	IOIF_InitLS(&lsObj[2], PELV_UPRIGHT_SLOPE, PELV_UPRIGHT_OFFSET_LEN); //R_L
	IOIF_InitLS(&lsObj[3], PELV_UPRIGHT_SLOPE, PELV_UPRIGHT_OFFSET_DEP); //R_D
...
//    		Push_Routine(&extDevCtrl.routine, 6);
//    		Push_Routine(&extDevCtrl.routine, 9);
//    }
...
void InitUpright(void){
	pelvicUpright[LEFT_LENGTH].pDirSw=0;
	pelvicUpright[LEFT_DEPTH].pDirSw=0;
	pelvicUpright[RIGHT_LENGTH].pDirSw=0;
	pelvicUpright[RIGHT_DEPTH].pDirSw=0;

	pelvicUpright[LEFT_LENGTH].nDirSw=0;
	pelvicUpright[LEFT_DEPTH].nDirSw=0;
	pelvicUpright[RIGHT_LENGTH].nDirSw=0;
	pelvicUpright[RIGHT_DEPTH].nDirSw=0;

	pelvicUpright[LEFT_LENGTH].pDirMotorIn=0;
	pelvicUpright[LEFT_DEPTH].pDirMotorIn=0;
	pelvicUpright[RIGHT_LENGTH].pDirMotorIn=0;
	pelvicUpright[RIGHT_DEPTH].pDirMotorIn=0;

	pelvicUpright[LEFT_LENGTH].nDirMotorIn=0;
	pelvicUpright[LEFT_DEPTH].nDirMotorIn=0;
	pelvicUpright[RIGHT_LENGTH].nDirMotorIn=0;
	pelvicUpright[RIGHT_DEPTH].nDirMotorIn=0;
