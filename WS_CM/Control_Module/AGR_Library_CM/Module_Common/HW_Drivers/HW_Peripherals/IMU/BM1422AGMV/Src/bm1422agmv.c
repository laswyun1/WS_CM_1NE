...
static void CalValues(BM1422AGMVObj_t* bm1422agmvObj);
...
static void CalValues(BM1422AGMVObj_t* bm1422agmvObj)
{
    ...
    for (int i = 0; i < BM1422AGMV_TOTAL_SENSORS; i++) {
        rawValues[i] = (int16_t)(bm1422agmvObj->dataBuff[i * 2 + 1] << 8 | bm1422agmvObj->dataBuff[i * 2]);
    }
