...
#include "bsp_uart.h" //Encountering a hard fault when using semaphores with DM
...
static BSP_UARTMap_t bsp_uartMap[BSP_UART_COUNT] = {
    ...
    {BSP_UART7, NULL},         // UART not defined
...
static BSP_UARTSemMap_t bsp_uartSemMap[BSP_UART_COUNT]  = {
    {BSP_UART_COUNT, 0, 0},
    {BSP_UART1, &BinSem_UART1Handle, BinSemUART1_TIMEOUT},
    ...
    {BSP_UART7, NULL, BinSemUART7_TIMEOUT},
 ...
 * @return HAL status.
 */
BSP_StatusTypeDef_t BSP_InitUART(BSP_UART_t uart, uint32_t baudrate)
{
